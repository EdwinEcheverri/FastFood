...
SELECT COUNT(OrdenID) AS Ordenes
FROM Ordenes;
...
SELECT COUNT(ClienteID) AS CantidadClientes
FROM Clientes;

/* 5. ¿Cuáles son las sucursales con un promedio de Facturación/Ingresos superior a 1000.00 
y que minimizan sus costos en base al promedio de kilómetros recorridos de todas de sus entregas 
gestionadas? Para un mejor relevamiento, ordene el listado por el Promedio Km Recorridos.*/
